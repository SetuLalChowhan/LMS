  ...
  return (
    ...
    >
      <Image
        ...
        alt="image"
        priority={100}
        style={{ width: "312px", height: "200px", objectFit: "cover" }}
      />
      ...
      <Link href={`/course/${item.id}`}>
        <ButtonIcon
          ...
          value={
            "text-blue text-[15px] border-2 bg-blue text-white rounded px-2 py-2 hover:opacity-75 duration-200 transition-all rounded-md"
          }
        />
      </Link>
    </div>
